  ...
  1: {
    ...
    makeJudge: () => {
      ...
      return {
        ...
        checks: () => [
          check('→ 누르면 오른쪽으로', ok.ArrowRight),
          check('← 누르면 왼쪽으로', ok.ArrowLeft),
          check('↑ 누르면 위로', ok.ArrowUp),
          check('↓ 누르면 아래로', ok.ArrowDown),
        ],
      }
    },
  },
    ...
    makeJudge: (ws) => {
      ...
      return {
        ...
        checks: () => {
          ...
          return [
            check("'번 반복하기' 블록 사용하기", usedTypes(ws).has('repeat_n')),
    ...
    makeJudge: (ws) => {
      ...
      return {
        ...
        checks: () => {
          ...
          return [
            check("'무한 반복하기' 사용하기", used.has('forever')),
  ...
  4: {
    ...
    example: {
      ...
      workspace: workspace([
        ...
        hat('when_key', { SPRITE: 'coco', KEY: 'Space' }, [30, 170],
    ...
    starter: workspace([
      ...
      hat('when_key', { SPRITE: 'coco', KEY: 'ArrowLeft' }, [30, 120], b('move_x', { DX: N(-15) })),
      hat('when_key', { SPRITE: 'coco', KEY: 'ArrowUp' }, [30, 210], b('move_y', { DY: N(15) })),
      hat('when_key', { SPRITE: 'coco', KEY: 'ArrowDown' }, [30, 300], b('move_y', { DY: N(-15) })),
    ], SCORE),
  ...
  5: {
    ...
    example: {
      ...
      workspace: workspace([
        ...
        hat('when_receive', { SPRITE: 'enemy', MSG: '시작' }, [30, 170],
    ...
    makeJudge: () => {
      ...
      return {
        ...
        checks: () => [
          check('시작 화면 → 게임 장면', progress >= 2),
          check('게임 장면 → 게임오버 장면', progress >= 3),
          check('메시지 보내고 받기', received),
        ],
      }
    },
  },
